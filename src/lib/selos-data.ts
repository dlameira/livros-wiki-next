...
export const GRUPO_DESCRICAO: Record<string, string> = {
  'Grupo Record': 'Fundado em 1942 no Rio de Janeiro, o Grupo Record é um dos maiores grupos editoriais do Brasil. Com mais de 20 selos, publica desde bestsellers internacionais e literatura de massa até obras de referência acadêmica, literatura infantojuvenil e pensamento crítico. O grupo controla nomes históricos como Bertrand Brasil, José Olympio, Civilização Brasileira e Galera.',
