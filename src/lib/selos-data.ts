...
export const GRUPO_DESCRICAO: Record<string, string> = {
  'Grupo Record': 'Fundado em 1942 no Rio de Janeiro, o Grupo Record é um dos maiores grupos editoriais do Brasil. Publica desde bestsellers internacionais e literatura de massa até obras de referência acadêmica, literatura infantojuvenil e pensamento crítico. O grupo reúne nomes históricos como Bertrand Brasil, José Olympio, Civilização Brasileira e Galera.',
  ...
  'Grupo Schwarcz': 'Fundado em 1986 por Luiz Schwarcz, o Grupo Companhia das Letras tornou-se referência em qualidade editorial no Brasil. Publica desde literatura estrangeira de prestígio até ficção brasileira contemporânea, com destaque para a Companhia das Letras, Penguin, Claro Enigma e Objetiva.',
  ...
  'Intrínseca': 'Fundada em 2007 no Rio de Janeiro, a Intrínseca tornou-se uma das cinco maiores editoras do Brasil em menos de duas décadas. Responsável por fenômenos como Cinquenta Tons de Cinza, Colleen Hoover e Outlive, é referência em detecção e lançamento de tendências.',
